...
export const DustbinIcon = ({ color }) => (
    <svg
    ...
    >
        <g display="none">
            <path display="inline" opacity="0.2" enableBackground="new" d="M84.6,0H80H20h-6.2H0v100h13h7h60h7.3H100V0 H84.6z M20,80V20h60v60H20z" />
        </g>
        <g display="none">
            <rect x="20.1" y="20.1" display="inline" fill="none" strokeWidth="0.25" strokeMiterlimit="10" width="59.8" height="59.8" />
        </g>
        <g display="none">
            <g display="inline" opacity="0.5">
                <line fill="none" strokeWidth="0.25" strokeMiterlimit="10" x1="79.9" y1="20.1" x2="20.1" y2="79.9" />
                <line fill="none" strokeWidth="0.25" strokeMiterlimit="10" x1="20.1" y1="20.1" x2="79.9" y2="79.9" />
                <g>
