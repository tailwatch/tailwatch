...
const ResumeModal = ({
    ...
    const onResume = async () => {
        ...
        try {
            ...
            formData.append("action_type", "tailwatch_resume_hardening_audit");
            ...
            if (response.data.success) {
                ...
                setErrorMessages((prevErrors) => [...prevErrors, "Failed to resume the hardening audit"]);
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title="Resume Hardening Audit"
            message="Do you want to resume or cancel the Hardening Audit?"
            onConfirm={handleResume}
            onCancel={handleCancelProcess}
            confirmLabel={isResuming ? 'Processing...' : 'Resume process'}
            cancelLabel={isCanceling ? 'Canceling...' : 'Cancel Process'}
