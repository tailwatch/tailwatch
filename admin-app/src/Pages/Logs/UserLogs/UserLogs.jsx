...
const UserLogs = () => {
  ...
  const option = 'default_logs_activity';
  ...
  const columns = [
    <CheckboxField checked={allSelected} onChange={handleSelectAll} 
         disabled={tabData.length === 0 || isTabDisabled}  
 />,
    "Title",
    "Body",
    "User Data",
  ...
  const handleRowClick = (index) => {
    ...
    if (log) {
      setSelectedLog({ ...log, isUser: true });
      setIsModalOpen(true);
    }
  };
          ...
          <div className="min-h-[400px] relative">
            ...
            {parentEnable === false && (
              <LockCard
                ...
                featureDescription="Track all logins, signups, and password resets with full visibility and optional alerts."
                featureId={getFeatureInfo().featureId}
