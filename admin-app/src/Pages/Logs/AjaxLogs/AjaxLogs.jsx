...
const AjaxLogs = () => {
  const activeTab = 'network-inspector';
  const key = 'default_feature_logs';
  const option = 'default_ajax_logs';
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="min-h-[400px] relative">
            ...
            {parentEnable === false && (
              <LockCard
                featureName="Network Inspector"
                featureDescription="Monitor WordPress AJAX, REST API, background requests, errors, and slow responses in real time."
                featureId={getFeatureInfo().featureId}
