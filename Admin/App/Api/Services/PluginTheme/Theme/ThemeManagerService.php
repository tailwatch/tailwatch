...
class ThemeManagerService {
	 ...
	 * }
	 */
	public static function wptw_activate_theme( string $theme_slug ): array {
	 ...
	 * }
	 */
	public static function wptw_delete_theme( string $theme_slug ): array {
	 ...
	 * }
	 */
	public static function wptw_get_all_themes( array $args = array() ): array {
		// Default arguments.
		$defaults = array(
			'page'         => 1,
			'limit'        => 10,
