 ...
 *
 * Handles client authentication via JWT tokens for mobile app access.
 *
 * @package    Tailwatch
...
class AuthController {
	 ...
	 * @var string
	 */
	private $rate_limit_key = 'wptw_login_attempts_';
	...
	public function login() {
		try {
			...
			$stored_secret = get_option( 'wptw_cta_secret_' . $client_id );
