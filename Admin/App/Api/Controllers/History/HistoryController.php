...
class HistoryController {
	 ...
	 */
	public function wptw_get_history( $post_data ) {
		try {
	 ...
	 */
	public function wptw_get_plugin_history( $post_data ) {
		try {
			$json_data = isset( $post_data ) ? wp_unslash( $post_data ) : '';
			$data      = json_decode( $json_data, true );
	 ...
	 */
	public function wptw_get_theme_history( $post_data ) {
		try {
			$json_data = isset( $post_data ) ? wp_unslash( $post_data ) : '';
			$data      = json_decode( $json_data, true );
	 ...
	 */
	public function wptw_get_core_history( $post_data ) {
		try {
			$json_data = isset( $post_data ) ? wp_unslash( $post_data ) : '';
			$data      = json_decode( $json_data, true );
